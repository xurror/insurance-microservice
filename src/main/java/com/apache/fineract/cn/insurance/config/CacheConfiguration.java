...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("InsuranceModule");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("InsuranceModule");
        ...
        config.getMapConfigs().put("com.apache.fineract.cn.insurance.domain.*", initializeDomainMapConfig(jHipsterProperties));
